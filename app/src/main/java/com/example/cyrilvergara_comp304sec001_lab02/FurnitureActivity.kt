...
class FurnitureActivity : AppCompatActivity() {
    ...
    private var fcheckBox: CheckBox? = null
    private var fcheckBox2: CheckBox? = null
    private var fcheckBox3: CheckBox? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_furniture)

        fcheckBox = findViewById<CheckBox>(R.id.fcheckBox)
        fcheckBox2 = findViewById<CheckBox>(R.id.fcheckBox2)
        fcheckBox3 = findViewById<CheckBox>(R.id.fcheckBox3)
    ...
    fun check(view: View?){
        ...
        val fcheckBoxState = fcheckBox!!.isChecked
        val fcheckBox2State = fcheckBox2!!.isChecked
        val fcheckBox3State = fcheckBox3!!.isChecked

        preferenceEditor.putBoolean("fcheckBoxState", fcheckBoxState)
        preferenceEditor.putString("fcheckBoxName", fcheckBox!!.text as String?)
        preferenceEditor.putBoolean("fcheckBox2State", fcheckBox2State)
        preferenceEditor.putString("fcheckBox2Name", fcheckBox2!!.text as String?)
        preferenceEditor.putBoolean("fcheckBox3State", fcheckBox3State)
        preferenceEditor.putString("fcheckBox3Name", fcheckBox3!!.text as String?)
